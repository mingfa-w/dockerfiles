...
CONTAINER_NAME=$USER.$tag.$PORT
# docker_in_docker=" --net=host --privileged -v /var/run/docker.sock:/var/run/docker.sock -v $(which docker):/bin/docker "
docker_in_docker=" -p 2605:340:cd51:4b00:6487:4fa6:bd78:6701:$PORT:22 --privileged -v /var/run/docker.sock:/var/run/docker.sock -v $(which docker):/bin/docker "
